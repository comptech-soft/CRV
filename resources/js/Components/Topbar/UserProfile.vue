<template>
    ...
    >
        ...
        >
            <span class="m-topbar__username">Login</span>
        </a>

        <!-- doar daca avem user logat -->
        <a v-if="$app.user" href="#" class="m-nav__link m-dropdown__toggle">
        ...
        <!-- doar daca avem user logat -->
        <div v-if="$app.user" class="m-dropdown__wrapper">
            ...
            <div class="m-dropdown__inner">
                <div 
                    ...
                    :style="{
                        'background': 'url(' + $app.url + '/metronic/media/img/misc/user_profile_bg.jpg)', 
                        ...
                        <ul class="m-nav m-nav--skin-light">
                            ...
                            <li class="m-nav__item">
                                <a href="profile.html" class="m-nav__link">
                                    ...
                                    <span class="m-nav__link-text">Option #1.1</span>
                                </a>
                            </li>
